 ...
 * @author Asitha
 */
public class PostgraduateForgotPassword extends javax.swing.JFrame {

    /**
     * Creates new form PostgraduateForgotPassword
     */
    public PostgraduateForgotPassword() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Postgraduate temp=new Postgraduate();
        try {
            temp=searchPostgraduate(IDTxt.getText());
            if(temp!=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostgraduateForgotPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PostgraduateForgotPassword().setVisible(true);
            }
        });
    }
