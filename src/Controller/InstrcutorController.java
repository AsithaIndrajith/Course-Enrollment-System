...
public class InstrcutorController {
     ...
     /**Search instructor by instructor id*/
    public static Instructor searchInstrcutorByInstructorID(String id) throws SQLException, ClassNotFoundException{
     ...
     /**Search instructor by department ID*/
    public static ArrayList<Instructor> searchInstrcutorByDepartmentID(String dep) throws SQLException, ClassNotFoundException{
