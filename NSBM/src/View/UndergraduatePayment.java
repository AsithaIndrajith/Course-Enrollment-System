 ...
 * @author Asitha
 */
public class UndergraduatePayment extends javax.swing.JFrame {
    
    /**
     * Creates new form UndergraduatePayment
     */
    public UndergraduatePayment() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UndergraduatePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UndergraduatePayment().setVisible(true);
            }
        });
    }
